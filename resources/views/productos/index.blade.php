<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
            ...
            <div class="mt-6 bg-white shadow-sm rounded-lg divide-y">
                ...
                @else
                    <div class="flex items-center p-4 text-sm text-gray-800 rounded-lg bg-gray-50 dark:bg-gray-800 dark:text-gray-300">
                        ...
                        <div class="text-base">
                        <span class="font-bold">No existen productos.</span> Crea y agrega el producto a la bodega ya existente.
                        </div>
        ...
        <div class="flex items-center p-4 text-sm text-gray-800 rounded-lg bg-gray-50 dark:bg-gray-800 dark:text-gray-300">
            ...
            <div class="text-base">
              <span class="font-bold">Aún no se han creado bodegas.</span> Debes crear una bodega para comenzar a agregar productos.
            </div>
